<template>
  <div class="table" @click.stop="trClear">
    ...
    <div class="table_section">
      <thead>
        <tr>
          <th>
            <input type="checkbox" id="allCheck" @click.stop="checkedAll">
          </th>
          <th>ID</th>
          <th>Name</th>
          <th>UserName</th>
      ...
      <tbody ref="tbody" >
        <tr v-for="(post, index) in posts" @click.stop="idFn(index)" :key="index" :class="{'tr': true, 'active' : post.active}">
          <td>
            <input type="checkbox" :id="post.id" @click.stop="idFn(index)" :checked="post.active">
          </td>
          <td>{{post.userId}}</td>
          <td>{{post.id}}</td>
          <td>{{post.title}}</td>
